                        ...
                        <div style={{ marginTop: '10px' }}>
                            ...
                            <div style={{ border: '1px solid #000', padding: '10px' }}>
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginTop: '10px', fontSize: '10px' }}>
                                    <div style={{ width: '48%' }}>
                                        <p style={{ margin: '3px 0' }}><strong>Supervisor Remarks:</strong> {claimDetails?.['SupervisorRemarks(ResearchProgress)'] || 'Satisfactory / Not Satisfactory'}</p>
                                        <br />
                                        {claimDetails?.isSupervisorApproved === 'approved' ? (
                                            <p style={{ margin: '3px 0', color: 'green', fontWeight: 'bold' }}>Digitally Verified &#10004;</p>
                                        ) : (
                                            <p style={{ margin: '3px 0' }}>__________________</p>
                                        )}
                                        <p style={{ margin: '3px 0' }}>Signature of Supervisor</p>
                                    </div>
                                    <div style={{ width: '48%', textAlign: 'right' }}>
                                        <p style={{ margin: '6px 0' }}><strong>HoD Remarks:</strong> {claimDetails?.['HodRemarks(Recommendation)'] || 'Recommended / Not Recommended'}</p>
                                        <br />
                                        {claimDetails?.isHodApproved === 'approved' ? (
                                            <p style={{ margin: '3px 0', color: 'green', fontWeight: 'bold' }}>Digitally Verified &#10004;</p>
                                        ) : (
                                            <p style={{ margin: '3px 0' }}>__________________</p>
                                        )}
                                        <p style={{ margin: '3px 0' }}>Signature of HoD</p>
                                    </div>
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginTop: '20px', fontSize: '10px' }}>
                                    <div style={{ width: '48%' }}>
                                        {claimDetails?.isDlcApproved === 'approved' ? (
                                            <p style={{ margin: '3px 0', color: 'green', fontWeight: 'bold' }}>Digitally Verified &#10004;</p>
                                        ) : (
                                            <p style={{ margin: '3px 0' }}>__________________</p>
                                        )}
                                    ...
                                    <div style={{ width: '48%', textAlign: 'right' }}>
                                        {claimDetails?.isadminApproved === 'approved' ? (
                                            <p style={{ margin: '3px 0', color: 'green', fontWeight: 'bold' }}>Digitally Verified &#10004;</p>
                                        ) : (
                                            <p style={{ margin: '3px 0' }}>__________________</p>
                                        )}
